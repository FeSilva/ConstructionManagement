...
return [
    ...
    "Armazenamento de Disco" => "Armazenamento de Disco",
    "Principal" => "Principal",
    "Relatório de Inspeção Predial" => "Relatório de Inspeção Predial",
    "Enviar Vistorias" => "Enviar Vistorias",
    "Empresas" => "Empresas",
    "Configurações" => "Configurações",
    "Medições" => 'Medição',
    "Lista de Envio" => "Lista de Envio",
    "Chamados" => 'Chamados',
    ...
    "Vistorias Enviadas" => "Vistorias Enviadas",
    "Orçamento Simples" => 'Orçamento Simples',
    "Orçamento Complexo" => 'Orçamento Complexo',
    "Especifica" => 'Específica',
    "Empreiteiras" => 'Empreiteiras',
    "Processo de Intervenção" => 'Processo de Intervenção',
    "Dashboard" => 'Painel',
    "Cadastros" => 'Cadastros',
    "Agenda" => 'Agenda',
